...
RUN curl -L https://github.com/nexus-xyz/nexus-cli/releases/latest/download/nexus-network-linux-x86_64 \
    -o /usr/local/bin/nexus-cli && chmod +x /usr/local/bin/nexus-cli
